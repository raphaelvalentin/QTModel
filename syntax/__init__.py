...
def xlabel(label, unit=None):
    plt[plt['currentname']]['xlabel'] = label
    plt[plt['currentname']]['xunit'] = unit
def ylabel(label, unit=None):
    plt[plt['currentname']]['ylabel'] = label
    plt[plt['currentname']]['yunit'] = unit
def plot(x, y, color=black):
    plt[plt['currentname']]['items'].append(('line', x, y, color))
def scatter(x, y, color=black):
    plt[plt['currentname']]['items'].append(('scatter', x, y, color))
